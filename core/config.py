...
class Config:
    def __init__(self, stopcode: int, ignore_headsigns: List[str], departure_count: int, visible_count: int, poll_rate: int , endpoint: str, window_size: List[int], fullscreen: bool, framerate: int) -> None:
